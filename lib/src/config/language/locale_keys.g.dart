...
abstract class LocaleKeys {
  ...
  static const String _changePhoneNumber = 'change_phone_number';
  static String get changePhoneNumber => _changePhoneNumber.tr();
  ...
  static const String _sendMessage = 'send_message';
  static String get sendMessage => _sendMessage.tr();

  static const String _messageText = 'message_text';
  static String get messageText => _messageText.tr();

  static const String _enterMessage = 'enter_message';
  static String get enterMessage => _enterMessage.tr();
  ...
  static const String _knowValueProperty = 'know_value_property';
  static String get knowValueProperty => _knowValueProperty.tr();
  ...
  static const String _enterPropertyArea = 'enter_property_area';
  static String get enterPropertyArea => _enterPropertyArea.tr();
  ...
  static const String _selectStreet = 'select_street';
  static String get selectStreet => _selectStreet.tr();

  static const String _directions = 'directions';
  static String get directions => _directions.tr();

  static const String _setDirections = 'set_directions';
  static String get setDirections => _setDirections.tr();

  static const String _interface = 'interface';
  static String get interface => _interface.tr();

  static const String _selectInterface = 'select_interface';
  static String get selectInterface => _selectInterface.tr();

  static const String _buildingAge = 'building_age';
  static String get buildingAge => _buildingAge.tr();

  static const String _determineAgeBuilding = 'determine_age_building';
  static String get determineAgeBuilding => _determineAgeBuilding.tr();

  static const String _finishingQuality = 'finishing_quality';
  static String get finishingQuality => _finishingQuality.tr();

  static const String _determineQualityFinishing = 'determine_quality_finishing';
  static String get determineQualityFinishing => _determineQualityFinishing.tr();

  static const String _numberFloors = 'number_floors';
  static String get numberFloors => _numberFloors.tr();

  static const String _determineNumberFloors = 'determine_number_floors';
  static String get determineNumberFloors => _determineNumberFloors.tr();
  ...
  static const String _buildingDetailsTitle = 'building_details_title';
  static String get buildingDetailsTitle => _buildingDetailsTitle.tr();

  static const String _bookAppointmentNow = 'book_appointment_now';
  static String get bookAppointmentNow => _bookAppointmentNow.tr();

  static const String _contactOwner = 'contact_owner';
  static String get contactOwner => _contactOwner.tr();

  static const String _bookInspection = 'book_inspection';
  static String get bookInspection => _bookInspection.tr();

  static const String _appointmentsAvailable = 'appointments_available';
  static String get appointmentsAvailable => _appointmentsAvailable.tr();

  static const String _chooseAppointmentExamination = 'choose_appointment_examination';
  static String get chooseAppointmentExamination => _chooseAppointmentExamination.tr();

  static const String _convertHomePage = 'convert_home_page';
  static String get convertHomePage => _convertHomePage.tr();

  static const String _wishUniqueExperience = 'wish_unique_experience';
  static String get wishUniqueExperience => _wishUniqueExperience.tr();

  static const String _searchResult = 'search_result';
  static String get searchResult => _searchResult.tr();

  static const String _searchFilter = 'search_filter';
  static String get searchFilter => _searchFilter.tr();

  static const String _purpose = 'purpose';
  static String get purpose => _purpose.tr();

  static const String _buildingType = 'building_type';
  static String get buildingType => _buildingType.tr();

  static const String _chooseBuildingType = 'choose_building_type';
  static String get chooseBuildingType => _chooseBuildingType.tr();
  ...
  static const String _newMobileNumber = 'new_mobile_number';
  static String get newMobileNumber => _newMobileNumber.tr();

  static const String _enterNewMobileNumber = 'enter_new_mobile_number';
  ...
  static const String _pleaseEnterTheCodeSentToYourMobilePhone = 'please_enter_the_code_sent_to_your_mobile_phone';
  static String get pleaseEnterTheCodeSentToYourMobilePhone => _pleaseEnterTheCodeSentToYourMobilePhone.tr();

  static const String _didntReceiveTheVerificationCode = 'didnt_receive_the_verification_code';
  static String get didntReceiveTheVerificationCode => _didntReceiveTheVerificationCode.tr();
  ...
  static const String _pleaseEnterYourLoginInformation = 'please_enter_your_login_information';
  static String get pleaseEnterYourLoginInformation => _pleaseEnterYourLoginInformation.tr();
